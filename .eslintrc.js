module.exports = {
    ...
    rules: {
        // 'no-console': process.env.NODE_ENV === 'production' ? 'error' : 'off',// 生产环境 无console
        'no-debugger': process.env.NODE_ENV === 'production' ? 'error' : 'off',// 生产环境 无 debugger
        // 关闭监测内容=============
